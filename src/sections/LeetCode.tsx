  ...
  return (
    <section className="flex justify-center items-center px-4">
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="group relative inline-flex items-center gap-3 px-5 py-2.5 bg-white dark:bg-zinc-900 rounded-full shadow-lg border border-orange-100 dark:border-orange-900/30 hover:border-orange-500 dark:hover:border-orange-500 transition-colors duration-300"
      >
        ...
        <div className="relative flex items-center justify-center w-8 h-8 bg-orange-100 dark:bg-orange-900/50 rounded-full text-orange-600 dark:text-orange-400 shrink-0">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            version="1.1"
            viewBox="0 0 120 120"
            className="items-center justify-center w-6 h-6 my-4"
          >
            <defs />
            <g
              id="LeetCode’s-new-logo"
              stroke="none"
              stroke-width="1"
              fill="none"
              fill-rule="evenodd"
            >
              <g
                transform="translate(-812.000000, -3714.000000)"
        ...
        <div className="relative flex flex-col items-start gap-px">
          <span className="text-sm font-semibold text-gray-800 dark:text-gray-200 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
            Hey, I started my LeetCode journey!
          </span>
          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">
            Keep up with my daily progress
          </span>
        </div>

        <svg
          className="w-4 h-4 text-gray-400 group-hover:text-orange-500 group-hover:translate-x-0.5 transition-all ml-1"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
